      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Fresh Watermelons Movie Trailers</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
        ...
        <div id="detailsTable" class="col-md-6 col-lg-6">
            <table style="margin-right:5px">
                ...
                <tr>
                    <td style="color:gray">Genre</td>
                    <td>{movie_genre}</td>
                </tr>
                <tr>
                    <td style="color:gray">Actors</td>
                    <td>{movie_actors}</td>
                </tr>
                <tr>
                    <td style="color:gray">Awards</td>
                    <td>{movie_awards}</td>
                </tr>
                <tr>
                    <td style="color:gray">Rating</td>
                    <td>{movie_rating} / {movie_votes}</td>
                </tr>
            </table>  
        </div>
    </div>
